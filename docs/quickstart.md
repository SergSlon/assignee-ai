...
5. **BP Evaluator** -- evaluates ~100 best practice rules (security, cost, reliability)
6. **Auto-Fix** -- patches fixable violations (e.g., enables S3 public access blocking)
...
8. **Human Approval** -- shows the plan and asks you to confirm (type "yes")
9. **Resource Provisioner** -- creates the resource via AWS CloudControl API
10. **Status Poller** -- polls until CloudControl reports SUCCESS or FAILED
