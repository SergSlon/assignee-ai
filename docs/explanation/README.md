...
| [`telemetry-design.md`](telemetry-design.md)             | Opt-in telemetry design and privacy model — design doc gating future PRs (no code yet)                                                                                           |

Also relevant at `docs/` root:
...
These canonical explanation docs stay at `docs/` root rather than
moving into `docs/explanation/` so existing inbound links from
external sources remain stable.
