/**
 * Parse ASSIGNEE_LLM_DEFAULT strings (`provider/model-id`) and validate the
 * provider is on the supported list.
 *
 * Lifted from `apps/cli/src/services/llm-adapter/model-parser.ts` in Story
 * 50-4 Wave 5.1. The CLI's old path becomes a thin re-export shim.
 */
