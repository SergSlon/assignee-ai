...
function validateSnsArnList(value: unknown): string | undefined {
...
export const commonFields: ResourcePlugin["commonFields"] = [
  {
    ...
    question: {
      ...
      validate: (value: unknown) => {
        ...
        const s = String(value);
        if (s.length > 255) return "Alarm name must be 255 characters or fewer";
        return undefined;
      },
    },
  },
...
export const advancedFields: ResourcePlugin["advancedFields"] = [
    ...
    question: {
      ...
      validate: (value: unknown) => {
        ...
        try {
          ...
          if (!Array.isArray(parsed)) return "Dimensions must be a JSON array";
  ...
  },
  {
    ...
    question: {
      ...
      options: [
        { value: "missing", label: "missing — Maintain current state" },
        { value: "breaching", label: "breaching — Treat as threshold breach" },
        {
          value: "notBreaching",
          label: "notBreaching — Treat as within threshold",
        },
        { value: "ignore", label: "ignore — Do not evaluate" },
      ],
