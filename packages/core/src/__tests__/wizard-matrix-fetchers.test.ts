...
// Story 50-4 Wave 5 Pass H: resolveDynamicFields was lifted to core along
// with wizard-helpers; it imports aws-resource-discovery via the
// core-internal path. Share a single set of spies across both mock targets
// so `vi.mocked(fn).mockResolvedValue(...)` in the test body affects both
// import sites identically.
