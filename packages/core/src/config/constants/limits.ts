 ...
 *
 * Lifted from apps/cli/src/config/constants/limits.ts in Story 50-4
 * Wave 5 Pass G so the in-core advisory-price-enricher (and future
 * pricing helpers) can use HOURS_PER_MONTH without reaching back into
 * the CLI app.
 */
