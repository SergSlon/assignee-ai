...
export const CFN_KEYS_WIZARD = {
  ...
  /** Set by s3-lifecycle-extractor when intent targets old/noncurrent object versions. */
  LIFECYCLE_NONCURRENT_EXPIRATION_DAYS: "LifecycleNoncurrentExpirationDays",
