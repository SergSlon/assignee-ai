 ...
 *
 * Lifted from apps/cli/src/config/project-config-loader.ts in Story 50-4
 * Wave 5 Pass G so the in-core graph can read project config without
...
import { validateConfig, type AssigneeConfig } from "./config-schema.js";
import { log, LOG_ACTIONS } from "../utils/logger/index.js";
import { CHECKPOINT_DIR, FileName } from "./constants/paths.js";
