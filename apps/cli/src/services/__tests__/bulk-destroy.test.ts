  ...
  describe("assignee infrastructure safety allowlist", () => {
    ...
    describe("L4 — allowlist is exact-name match, not prefix or greedy wildcard", () => {
      ...
      it("rejects AssigneeOperator-evil (dash-squat attack)", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:policy/AssigneeOperator-evil",
          ),
        ).toBe(false);
      });
      ...
      it("rejects AssigneeOperator2 (digit-suffix squat attack)", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:policy/AssigneeOperator2",
          ),
        ).toBe(false);
      });
      ...
      it("rejects AssigneeOperatorPolicyClone (suffix-clone attack)", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:policy/AssigneeOperatorPolicyClone",
          ),
        ).toBe(false);
      });
      ...
      it("rejects AssigneeAiBedrockEvilRole (was allowed under old `Bedrock\\w*` arm)", () => {
        ...
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:role/AssigneeAiBedrockEvilRole",
          ),
        ).toBe(false);
      });
      ...
      it("rejects AssigneeAiBedrockLoggingRoleShadow (suffix-clone on Bedrock arm)", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:role/AssigneeAiBedrockLoggingRoleShadow",
          ),
        ).toBe(false);
      });
      ...
      it("rejects bare 'bedrock-evil' — not prefixed with Assignee", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:role/bedrock-evil",
          ),
        ).toBe(false);
      });
      ...
      it("rejects BedrockExecutionRole — not prefixed with Assignee", () => {
        expect(
          isAssigneeInfraResource(
            "arn:aws:iam::054125018476:role/BedrockExecutionRole",
          ),
        ).toBe(false);
      });
    });
