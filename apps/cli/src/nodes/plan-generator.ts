 ...
 *
 * Exported for unit tests (see plan-generator.structuredClone.test.ts).
 */
  ...
  return async function planGeneratorNode(
    ...
    if (
      ...
      if (
        ...
        // P1-R2-8: safeCloneDesiredState enforces plain-object shape and
        // wraps DataCloneError with an actionable hint. Previously the
        // JSON-based clone silently coerced non-serializable values.
