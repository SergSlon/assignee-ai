...
it("renderCompoundSuccess prefers explicit displayArns map over each resource's bare resourceArn", async () => {
  ...
  renderCompoundSuccess(
    ...
    {
      "vpc-1": "arn:aws:ec2:us-east-1:054125018476:vpc/vpc-0123456789abcdef0",
      "subnet-1":
        "arn:aws:ec2:us-east-1:054125018476:subnet/subnet-0123456789abcdef0",
    },
  );
  restore();
  ...
  expect(output).toContain(
    "arn:aws:ec2:us-east-1:054125018476:vpc/vpc-0123456789abcdef0",
  );
  expect(output).toContain(
    "arn:aws:ec2:us-east-1:054125018476:subnet/subnet-0123456789abcdef0",
  );
