 ...
 * were issued with. If `assignee dev setup` rotates an operator user to a
 ...
 *
 * Scope is intentionally restricted to the three roles `assignee dev setup`
...
export function mergeEnvFile(
  ...
  if (newKeys.length > 0) {
    ...
    processedLines.push(
      "# ── Assignee.ai IAM Credentials (generated by assignee dev setup) ──",
    );
