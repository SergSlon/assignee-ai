...
# Options for 'apply'
complete -c assignee -n "__fish_seen_subcommand_from apply" -l wizard -d 'Run the interactive configuration wizard.'
...
complete -c assignee -n "__fish_seen_subcommand_from init" -l wizard -d 'Run the interactive configuration wizard.'
